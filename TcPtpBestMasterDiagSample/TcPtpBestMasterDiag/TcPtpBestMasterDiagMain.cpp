...
class CTcPtpBestMasterDiagCtrl : public ITcOCFCtrlImpl<CTcPtpBestMasterDiagCtrl, CTcPtpBestMasterDiagClassFactory>
{
public:
...
{
	HRESULT hr = E_FAIL;
	TRACE("TcPtpBestMasterDiag: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CTcPtpBestMasterDiagCtrl>;
